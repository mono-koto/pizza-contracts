...
contract SimpleSplitterForkTest is Test {
    ...
    address constant PYUSD_ADDRESS = 0x637A1259C6afd7E3AdF63993cA7E58BB438aB1B1;
    ...
    function setUp() public {
        ...
        // Get PYUSD contract
        pyusd = IERC20Metadata(PYUSD_ADDRESS);
    ...
    function test_fork_pyusdProperties() public {
        ...
        assertEq(pyusd.symbol(), "FLX", "Token symbol should be FLX");
        assertEq(pyusd.name(), "Flux USD", "Token name should be Flux USD");
    }

    function test_fork_splitterConfiguration() public {
        // Verify splitter is configured correctly with PYUSD
        assertEq(address(splitter.token()), PYUSD_ADDRESS);
    ...
    function test_fork_multipleDistributions() public {
        ...
        deal(PYUSD_ADDRESS, address(splitter), amount1);
        splitter.distribute();
        ...
        deal(PYUSD_ADDRESS, address(splitter), amount2);
        splitter.distribute();
